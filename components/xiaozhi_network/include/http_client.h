...
#define HTTP_CLIENT_EVENT_HEADERS_RECEIVED (1 << 0)
#define HTTP_CLIENT_EVENT_BODY_RECEIVED (1 << 1)
#define HTTP_CLIENT_EVENT_ERROR (1 << 2)
#define HTTP_CLIENT_EVENT_COMPLETE (1 << 3)
